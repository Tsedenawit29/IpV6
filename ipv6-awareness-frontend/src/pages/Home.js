  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-primary/5 dark:from-dark-bg-primary dark:to-dark-bg-secondary">
      ...
      <motion.section 
        ...
        className="relative min-h-[90vh] flex items-center bg-gradient-to-br from-white via-primary/5 to-primary/10 dark:from-dark-bg-primary dark:via-dark-bg-secondary dark:to-dark-bg-primary text-primary dark:text-dark-text-primary py-32 transition-colors duration-200 overflow-hidden"
      >
        {/* Animated background elements */}
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_30%_20%,rgba(0,196,124,0.15),transparent_50%)] dark:bg-[radial-gradient(circle_at_30%_20%,rgba(0,196,124,0.08),transparent_50%)]"></div>
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_70%_80%,rgba(0,196,124,0.15),transparent_50%)] dark:bg-[radial-gradient(circle_at_70%_80%,rgba(0,196,124,0.08),transparent_50%)]"></div>
