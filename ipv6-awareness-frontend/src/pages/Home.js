  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-primary/5 dark:from-primary-dark dark:to-primary/10">
      ...
      <motion.section 
        ...
        className="relative bg-gradient-to-br from-white via-primary/10 to-primary dark:from-primary-dark dark:via-primary/20 dark:to-primary-dark text-primary dark:text-white py-32 transition-colors duration-200 overflow-hidden"
      >
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_30%_20%,rgba(0,255,0,0.15),transparent_50%)] dark:bg-[radial-gradient(circle_at_30%_20%,rgba(0,255,0,0.08),transparent_50%)]"></div>
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_70%_80%,rgba(255,215,0,0.15),transparent_50%)] dark:bg-[radial-gradient(circle_at_70%_80%,rgba(255,215,0,0.08),transparent_50%)]"></div>
        ...
        <div className="container mx-auto px-4 relative">
          <div className="max-w-4xl mx-auto text-center">
            <motion.div
              ...
              className="mb-12"
            >
              <div className="inline-block p-4 rounded-2xl bg-accent/10 dark:bg-accent/20 mb-8">
                <FaGlobe className="text-6xl text-accent" />
              </div>
              <div className="space-y-4">
                ...
                <motion.h1 
                  ...
                  className="text-6xl md:text-8xl font-bold mb-8 text-primary dark:text-accent leading-tight"
                >
                  The Future is <span className="text-accent dark:text-secondary relative">
                    IPv6
                ...
                <motion.p 
                  ...
                  className="text-xl md:text-2xl mb-12 text-primary/80 dark:text-secondary/90 leading-relaxed max-w-2xl mx-auto"
                >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {stats.map((stat, index) => (
              ...
              >
                ...
                <div className="text-primary/80 dark:text-secondary/80">{stat.label}</div>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <section className="py-16 px-4">
        <div className="container mx-auto">
          <h2 className="text-3xl font-bold text-center text-[#004D00] dark:text-white mb-12">
            Why IPv6 Matters
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {benefits.map((benefit, index) => (
              ...
              >
                <div className="text-[#FFD700] mb-4">{benefit.icon}</div>
                ...
                <div className="text-[#FFD700] font-semibold">{benefit.stat}</div>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      {/* Features Section */}
      <section className="py-16 px-4 bg-gradient-to-b from-white to-[#004D00]/5 dark:from-[#004D00]/5 dark:to-[#004D00]/10">
        <div className="container mx-auto">
          <h2 className="text-3xl font-bold text-center text-[#004D00] dark:text-white mb-12">
            Key Features
          </h2>
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto">
          <motion.h2 
            ...
            viewport={{ once: true }}
            className="text-4xl font-bold text-center mb-16 text-primary dark:text-accent"
          >
            IPv6 Status
          </motion.h2>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <motion.div
              ...
              viewport={{ once: true }}
              className="group bg-white dark:bg-primary/5 rounded-xl shadow-lg overflow-hidden"
            >
            ...
            >
              <div className="relative h-64 overflow-hidden">
                <img 
                  ...
                  alt="Regional IPv6 Statistics" 
                  className="w-full h-full object-cover transform group-hover:scale-110 transition-transform duration-500"
                />
                <div className="absolute inset-0 bg-gradient-to-t from-primary/90 to-transparent"></div>
                <div className="absolute bottom-0 left-0 right-0 p-6">
                  <h3 className="text-2xl font-semibold text-white mb-4">Regional Stats</h3>
                  <div className="flex items-center gap-4 mb-3">
                    <FaCheckCircle className="text-accent text-xl" />
                    <span className="text-white/90">Leading regions show high adoption</span>
                  </div>
                  <div className="flex items-center gap-4">
                    <FaExclamationTriangle className="text-yellow-400 text-xl" />
                    <span className="text-white/90">Some regions need more support</span>
                  </div>
                </div>
              </div>
            </motion.div>
