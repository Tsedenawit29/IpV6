        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-4">
            <div className="flex items-center space-x-4 mb-8 group">
              ...
              />
              <div>
                <h3 className="text-2xl font-bold text-[#228B22] group-hover:from-green-400 group-hover:to-green-500 transition-all duration-300">
                  IPv6 Awareness
                </h3>
            ...
            <div className="flex space-x-6">
              {socialLinks.map((social) => (
                <a
                  key={social.name}
                  href={social.url}
                  className="text-black dark:text-dark-text-secondary hover:text-[#228B22] dark:hover:text-green-400 transform hover:scale-110 transition-all duration-300"
                  target="_blank"
                  ...
                  <ul className="space-y-3">
                    {links.map(({ label, path }) => (
                      <li key={path}>
                        <Link
                          to={path}
                          className="text-black dark:text-dark-text-secondary hover:text-[#228B22] dark:hover:text-green-400 transform hover:translate-x-1 transition-all duration-300 inline-block text-base"
                        >
                          {label}
                        </Link>
                      </li>
